...
```
# Creating a grouped bar plot for the top 10 countries showing the counts of each hotel_type
```{r}
...
# Create a grouped bar chart for non-canceled reservations and guest types
